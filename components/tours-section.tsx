...
export function ToursSection() {
  ...
  const tours = [
    {
      title: t("tours.nature.title"),
      duration: `4 ${t("tours.duration")}`,
      difficulty: t("tours.difficulty.medium"),
      participants: `2-8 ${t("tours.participants")}`,
      price: "€55",
      description: t("tours.nature.description"),
      highlights: ["Sorgenti di acqua pura", "Cascate nascoste", "Boschi incontaminati", "Panorami mozzafiato"],
    },
    {
      title: t("tours.panoramic.title"),
      duration: `4 ${t("tours.duration")}`,
      difficulty: t("tours.difficulty.easy"),
      participants: `2-10 ${t("tours.participants")}`,
      price: "€50",
      description: t("tours.panoramic.description"),
      highlights: ["Punti panoramici spettacolari", "Borghi medievali", "Storia e tradizioni", "Relax totale"],
    },
    {
      title: t("tours.wine.title"),
      duration: `3.5 ${t("tours.duration")}`,
      difficulty: t("tours.difficulty.easy"),
      participants: `2-6 ${t("tours.participants")}`,
      price: "€75",
      description: t("tours.wine.description"),
      highlights: ["Antica Cantina Leonardi", "Picnic con vista lago", "Degustazione 3 vini", "Visita cantina storica"],
    },
  ]
